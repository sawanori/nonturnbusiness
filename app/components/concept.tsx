...
export const Concept: FC = () => {
    ...
    return (
        <div ref={refContainer} className='bg-gradient-to-r from-gray-200 to-gray-100 text-black '>
            <div className='min-h-screen max-w-5xl mx-auto px-10 lg:px-20 py-24 md:py-28 lg:py-36 flex flex-col justify-center items-center text-xl md:text-5xl lg:text-6xl tracking-tight font-semibold'>
